...
export const SECRET_WORDS = [
  ...
  // Objetos cotidianos (adicionais)
  "Lâmpada", "Cobertor", "Almofada", "Balde", "Sabonete",
  "Frigideira", "Xícara", "Panela", "Pneu", "Fechadura",
  "Lanterna", "Capacete", "Isqueiro", "Termômetro", "Guarda-roupa",
  "Lençol", "Toalha", "Porta", "Janela", "Gaveta",
  // Animais (adicionais)
  "Crocodilo", "Girafa", "Rinoceronte", "Hipopótamo", "Guepardo",
  "Ornitorrinco", "Canguru", "Koala", "Foca", "Cabra",
  "Lontra", "Tatu", "Piranha", "Lula", "Caranguejo",
  "Morcego", "Beija-flor", "Pavão", "Escorpião", "Veado",
  // Alimentos (adicionais)
  "Abacate", "Açaí", "Camarão", "Mostarda", "Iogurte",
  "Manteiga", "Milho", "Pudim", "Crepe", "Waffle",
  "Bacon", "Torta", "Acarajé", "Paella", "Gyoza",
  "Falafel", "Fondue", "Feijão", "Arroz", "Pão de forma",
  // Tecnologia (adicionais)
  "Smartwatch", "Roteador", "Webcam", "Joystick", "Scanner",
  "Monitor", "Pendrive", "GPS", "Headset", "Impressora 3D",
  // Natureza (adicionais)
  "Maré", "Dunas", "Falésia", "Monção", "Neve",
  "Pântano", "Manguezal", "Geada", "Tornado", "Tsunami",
  "Eclipse", "Cometa", "Meteoro", "Geleira", "Bambu",
  // Transporte (adicionais)
  "Patinete", "Kart", "Jangada", "Canoa", "Hoverboard",
  "Charrete", "Veleiro", "Ônibus", "Reboque", "Carro elétrico",
  // Lugares (adicionais)
  "Catedral", "Estádio", "Palácio", "Porto", "Arena",
  "Hangar", "Sótão", "Celeiro", "Masmorra", "Trapiche",
  // Esportes e lazer (adicionais)
  "Boxe", "Tênis", "Natação", "Judô", "Capoeira",
  "Remo", "Esgrima", "Hipismo", "Kitesurf", "CrossFit",
  // Objetos temáticos (adicionais)
  "Estetoscópio", "Bengala", "Agulha", "Balança", "Cofre",
  "Âncora", "Luneta", "Cadeado", "Bigorna", "Tridente",
  // Conceitos abstratos (adicionais)
  "Liberdade", "Destino", "Paradoxo", "Caos", "Instinto",
  "Fronteira", "Equilíbrio", "Abismo",
  // Objetos cotidianos (novos)
  "Cadeira", "Mesa", "Sofá", "Tapete", "Cortina", "Escada", "Faca", "Garfo", "Prato", "Jarra",
  "Vassoura", "Funil", "Rolo de pintura", "Saco de dormir", "Mosquiteiro", "Filtro de café",
  "Cesto", "Pente", "Navalha", "Barbeador",
  // Animais (novos)
  "Capivara", "Arara", "Tucano", "Onça", "Tamanduá", "Jacaré", "Lobo-guará", "Anta", "Sabiá", "Boto",
  "Mico-leão-dourado", "Emu", "Axolote", "Chimpanzé", "Búfalo", "Cisne", "Pelicano",
  "Carcará", "Lagartixa", "Paca",
  // Alimentos (novos)
  "Espaguete", "Risoto", "Yakisoba", "Moqueca", "Feijoada", "Canjica", "Pão de queijo",
  "Stroganoff", "Escondidinho", "Salpicão", "Tempurá", "Tacos", "Burrito", "Pho",
  "Shawarma", "Ceviche", "Frango assado", "Costela", "Linguiça", "Cuscuz",
  // Tecnologia (novos)
  "Servidor", "Satélite", "Robô", "Óculos VR", "Radar", "Sonar", "HD externo",
  "Processador", "Placa de vídeo", "Chip", "Tela OLED", "Projetor", "Câmera de segurança",
  "Cabo USB", "Bateria externa", "Painel solar", "Turbina eólica", "Caixa registradora",
  "Leitor de impressão digital", "Braço robótico",
  // Natureza (novos)
  "Rio", "Mar", "Oceano", "Montanha", "Savana", "Tundra", "Vale", "Cânion", "Baía",
  "Arquipélago", "Delta", "Recife", "Colina", "Planície", "Galáxia", "Estrela",
  "Nebulosa", "Asteroide", "Planeta", "Pico",
  // Transporte (novos)
  "Moto", "Táxi", "Metrô", "Bondinho", "Hidroavião", "Lancha", "Jet ski", "Segway",
  "Caminhão", "Tuk-tuk", "Balsa", "Bonde", "Kayak", "Ciclomotor", "Carro de corrida",
  "Limusine", "Van", "Triciclo", "Moto de neve", "Trem de carga",
  // Lugares (novos)
  "Orfanato", "Convento", "Mosteiro", "Cabana", "Chalé", "Mansão", "Quartel", "Tribunal",
  "Embaixada", "Mina", "Planetário", "Zoológico", "Jardim botânico", "Ilha", "Fortaleza",
  "Catacomba", "Metrópole", "Aldeia", "Oásis", "Ruínas",
  // Esportes (novos)
  "Futebol", "Basquete", "Vôlei", "Handebol", "Beisebol", "Rugby", "Hóquei", "Badminton",
  "Ping-pong", "Taekwondo", "Karatê", "Atletismo", "Ciclismo", "Triatlo", "Patinação",
  "Snowboard", "Wakeboard", "Rapel", "Slackline", "Cabo de guerra",
  // Instrumentos musicais
  "Guitarra", "Bateria", "Baixo", "Piano", "Saxofone", "Trompete", "Alaúde", "Harpa",
  "Acordeão", "Flauta", "Gaita", "Violoncelo", "Trombone", "Clarinete", "Contrabaixo",
  "Banjo", "Ukulelê", "Didgeridoo", "Berimbau", "Sitar",
  // Conceitos (novos)
  "Tempo", "Energia", "Magia", "Acaso", "Karma", "Coragem", "Lealdade", "Traição",
  "Esperança", "Dúvida", "Solidão", "Fama", "Poder", "Mito", "Lenda",
  "Profecia", "Maldição", "Ilusão", "Ritual", "Fantasia",
];
...
const WORD_HINTS: Record<string, string> = {
  ...
  "Colchão": "Espuma",
  "Ventilador": "Aparelho",
  "Escova de dente": "Utensílio",
  "Garrafa térmica": "Recipiente",
  ...
  "Câmera": "Eletrônico",
  "Drone": "Aeronave",
  "Impressora": "Eletrônico",
  "Teclado": "Periférico",
  "Mouse": "Periférico",
  "Tablet": "Eletrônico",
  "Microfone": "Aparelho",
  "Alto-falante": "Aparelho",
  ...
  "Arco-íris": "Espectro",
  // Transporte
  "Submarino": "Embarcação",
  "Foguete": "Aeronave",
  "Helicóptero": "Aeronave",
  "Navio": "Embarcação",
  "Trem bala": "Veículo",
  "Teleférico": "Transporte",
  "Moto aquática": "Veículo",
  "Planador": "Aeronave",
  "Zeppelin": "Aeronave",
  "Bicicleta": "Veículo",
  "Trator": "Máquina",
  "Ambulância": "Veículo",
  // Lugares
  "Biblioteca": "Edificação",
  "Castelo": "Fortaleza",
  "Farol": "Torre",
  "Pirâmide": "Monumento",
  "Iglu": "Abrigo",
  "Bunker": "Abrigo",
  "Observatório": "Instalação",
  "Labirinto": "Estrutura",
  "Cemitério": "Terreno",
  "Aquário": "Instalação",
  "Museu": "Edificação",
  "Circo": "Espetáculo",
  // Esportes e lazer
  "Paraquedas": "Equipamento",
  "Skate": "Prancha",
  "Escalada": "Esporte",
  "Mergulho": "Imersão",
  "Arco e flecha": "Equipamento",
  "Xadrez": "Jogo",
  "Boliche": "Jogo",
  "Golfe": "Esporte",
  "Surfe": "Esporte",
  ...
  "Vassoura": "Limpeza",
  "Funil": "Utensílio",
  "Rolo de pintura": "Ferramenta",
  "Saco de dormir": "Equipamento",
  "Mosquiteiro": "Proteção",
  "Filtro de café": "Utensílio",
  "Cesto": "Recipiente",
  "Pente": "Acessório",
  "Navalha": "Ferramenta",
  "Barbeador": "Higiene",
  ...
  "Satélite": "Aeronave",
  "Robô": "Máquina",
  "Óculos VR": "Eletrônico",
  "Radar": "Instrumento",
  "Sonar": "Instrumento",
  "HD externo": "Memória",
  "Processador": "Componente",
  "Placa de vídeo": "Componente",
  "Chip": "Componente",
  "Tela OLED": "Tela",
  "Projetor": "Eletrônico",
  "Câmera de segurança": "Eletrônico",
  "Cabo USB": "Acessório",
  "Bateria externa": "Eletrônico",
  "Painel solar": "Energia",
  "Turbina eólica": "Energia",
  "Caixa registradora": "Máquina",
  "Leitor de impressão digital": "Eletrônico",
  "Braço robótico": "Máquina",
  // Natureza (novos)
  "Rio": "Água",
  "Mar": "Água",
  "Oceano": "Água",
  ...
  "Kayak": "Embarcação",
  "Ciclomotor": "Veículo",
  "Carro de corrida": "Veículo",
  "Limusine": "Veículo",
  "Van": "Veículo",
  "Triciclo": "Veículo",
  "Moto de neve": "Veículo",
  "Trem de carga": "Veículo",
  // Lugares (novos)
  "Orfanato": "Edificação",
  "Convento": "Templo",
  "Mosteiro": "Templo",
  ...
  "Quartel": "Edificação",
  "Tribunal": "Edificação",
  "Embaixada": "Edificação",
  "Mina": "Escavação",
  "Planetário": "Edificação",
  "Zoológico": "Parque",
  "Jardim botânico": "Parque",
  "Ilha": "Território",
  "Fortaleza": "Edificação",
  "Catacomba": "Subterrâneo",
  "Metrópole": "Cidade",
  "Aldeia": "Cidade",
  "Oásis": "Paisagem",
  "Ruínas": "Estrutura",
  ...
  "Alaúde": "Instrumento",
  "Harpa": "Instrumento",
  "Acordeão": "Instrumento",
  "Flauta": "Instrumento",
  "Gaita": "Instrumento",
  "Violoncelo": "Instrumento",
  "Trombone": "Instrumento",
  "Clarinete": "Instrumento",
  "Contrabaixo": "Instrumento",
  "Banjo": "Instrumento",
  "Ukulelê": "Instrumento",
  "Didgeridoo": "Instrumento",
...
export function getHintForMode(mode: GameMode, secretInfo: unknown): string {
  switch (mode) {
    case "secret-word": {
      ...
      return WORD_HINTS[info.word] ?? "Objeto";
    }
    case "location-role": {
